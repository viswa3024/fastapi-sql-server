...
# Replace sa/rest123 with your credentials if different
DATABASE_URL = "mssql+pyodbc://sa:viswa1234@localhost\\SQLEXPRESS/EMPLOYEE?driver=ODBC+Driver+17+for+SQL+Server"
